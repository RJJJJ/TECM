...
requireMatch(workflow, /name: Verify attendance function ACL M36\/M37 mutation resistance\s+run: node scripts\/testing\/attendance-function-acl-mutation-verify\.mjs/, 'Attendance function ACL M37 mutation verification is required');
